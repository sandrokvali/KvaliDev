...
jQuery(function ($) {
  ...
  MineSweeper = function () {
    ...
    this.getTemplate = function (template) {
      let templates = {
        settings:
          '<div class="game_settings"><select id="level" class="msLevel"><option value="beginner">დამწყები</option>' +
          '<option value="intermediate">კარგი მოთამაშე</option><option value="expert">ექსპერტი</option>' +
          '<option value="custom">შენი რეჟიმი</option></select>' +
          ...
          '<input type="text" id="numMines" class="msNumMines" placeholder="ბომბა" size="5" disabled />' +
          '</div>',
        actions:
          '<div class="game_actions"><button class="new-game">ახალი თამაში</button>' +
          '<button id="bestTimes">ყველაზე კარგი თამაშები</button></div>' +
          '<button id="pause" class="msPause">Pause</button></div>',
        status:
          '<div class="game_status"><label>დრო:</label>' +
