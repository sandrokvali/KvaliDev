class Game {
    ...
    constructor() {
        ...
        this.colors = ["#FF4571", "#2986cc", "#4CBB17"]; // the 3 colors used in the game
    ...
    * Display score
     ...
     */
    showGrade(score) {
        if(score > 30) return "ჩაკ ნორის?";
        else if(score > 25) return "შენ ხარ კაცი თუ ხარ!";
        else if(score > 20) return "შესანიშნავია!";
        else if(score > 15) return "კარგია!";
        else if(score > 13) return "მაგარი ხარ!";
        else if(score > 10) return "საღოლ!";
        else if(score > 5) return "მართლა?";
        else return "ეჰჰ...";
    }
...
class Color {
    ...
    constructor() {
        this.colors = ["#FF4571", "#4CBB17", "#2986cc"];
    ...
    colorcodeToName(color) {
        let colors = ["#FF4571", "#4CBB17", "#2986cc"];
